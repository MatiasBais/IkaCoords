...
<thead>
        ...
        $sql = "select player.nombre as 'nombre', alianza.nombre as 'Alianza', DATE_FORMAT(ub.fecha,'%d/%m/%y') as 'Fecha',FORMAT((b.Constructor+b.Investigadores+b.Generales),0)as 'Totales',b.Constructor as 'Constructor',b.investigadores as 'Investigadores', b.Generales as 'Generales', b.oro as 'Oro',ub.numero from player
