...
<body class="body">
  ...
  <div class="left">
      <table id="left-table">
        ...
        <th>Search</th>
        <tr><td><a href="search/inactivesearch.php">Inactive Search</a></td></tr>
        <tr><td><a href="search/searchisland.php">Search Island</a></td></tr>
        <tr><td><a href="search/searchtown.php">Search Town</a></td></tr>
        <tr><td><a href="search/searchplayer.php">Search Player</a></td></tr>
        <tr><td><a href="search/searchalliance.php">Search Alliance</a></td></tr>
        <tr><td><a href="search/deluxe.php">DELUXE</a></td></tr>
    </table>       
...
The towns adviser provides the players with updates on the player's empire. He notifies the player In addition, the town adviser lets the player manage trade routes, a paid feature that allows the player to ship resources from one of the player's towns to another town regularly.
...
<p>This article is based on the article Ikariam from the encyclopedia Wikipedia and is licensed under the GNU-Free Documentation License and Creative Commons CC-BY-SA 3.0 Unported (Abstract). A list of authors is available at Wikipedia.</p>
