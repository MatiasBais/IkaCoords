    ...
    <select name="fecha2" id="fecha2">
        ...
        if($result->rowCount() > 0):
            ...
            foreach($rows as $row):
                ...
                ?>
                <option value="<?php echo $row['numero'];?>" <?php if($fecha2==$row['numero']) echo 'selected'; ?>><?php echo $row['Fecha'] ?></option>
...
<table class="results">
        ...
        <tr class="active-row">
        <td><?php echo $i; ?></td>
            <td><a href="../search/searchplayer.php?player=<?php echo $row['nombre'];?>&server=<?php echo $server;?>"><?php echo $row['nombre'];  ?></a></td>
